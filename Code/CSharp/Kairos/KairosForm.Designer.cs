namespace Kairos
{
	partial class KairosForm
	{
		...
		private void InitializeComponent()
		{
			...
			this._lblComponent = new ToolStripLabel();
			...
			this.menuStrip1.Items.AddRange(new ToolStripItem[] { this.collectionToolStripMenuItem, this.projectToolStripMenuItem, this.activityToolStripMenuItem, this.editToolStripMenuItem3, this.toolsToolStripMenuItem, this.helpToolStripMenuItem });
			...
			this.newToolStripMenuItem1.ToolTipText = "Adds a new component to the current fixture";
			this.newToolStripMenuItem1.Click += this.OnComponentNew;
			// 
			...
			this.editToolStripMenuItem1.Click += this.OnComponentEdit;
			// 
			...
			this.deleteToolStripMenuItem.ToolTipText = "Deletes selected project from the fixture";
			this.deleteToolStripMenuItem.Click += this.OnComponentDelete;
			// 
			...
			this.toolStrip1.Items.AddRange(new ToolStripItem[] { this.toolStripButton1, this.toolStripButton2, this.toolStripButton4, this.toolStripButton5, this.toolStripButton6, this.toolStripSeparator6, this.toolStripButton3, this._lblComponent, this._lblCollection, this._btStart, this._btStop, this.toolStripSeparator5 });
			...
			this.toolStripButton1.ToolTipText = "Opens a project from file";
			...
			this.toolStripButton2.ToolTipText = "Saves the current project under a new file name";
			...
			this.toolStripButton4.ToolTipText = "Adds a new component to the currenty project";
			this.toolStripButton4.Click += this.OnComponentNew;
			// 
			// toolStripButton5
			// 
			...
			this.toolStripButton5.ToolTipText = "Adds a new activity to selected component";
			...
			this.toolStripButton3.Click += this.OnProjectQuit;
			// 
			// _lblComponent
			// 
			this._lblComponent.Alignment = ToolStripItemAlignment.Right;
			this._lblComponent.Font = new Font("Consolas", 14F);
			this._lblComponent.ForeColor = Color.ForestGreen;
			this._lblComponent.Name = "_lblComponent";
			this._lblComponent.Size = new Size(168, 37);
			this._lblComponent.Text = "Component...";
			// 
			// _lblCollection
			// 
			...
			// _scKairos.Panel1
			// 
			this._scKairos.Panel1.Controls.Add(this._tvComponents);
			// 
			// _scKairos.Panel2
			// 
			...
			this._tvComponents.ImageList = this._ilIssues;
			this._tvComponents.Location = new Point(0, 0);
			this._tvComponents.Name = "_tvComponents";
			...
			this._cmsComponent.Size = new Size(223, 82);
			// 
			...
			this.editProjectToolStripMenuItem.Click += this.OnComponentEdit;
			// 
			...
			this.deleteProjectToolStripMenuItem.Click += this.OnComponentDelete;
			// 
			// toolStripSeparator3
			// 
			this.toolStripSeparator3.Name = "toolStripSeparator3";
			this.toolStripSeparator3.Size = new Size(219, 6);
			// 
			// addToolStripMenuItem
			// 
			this.addToolStripMenuItem.Name = "addToolStripMenuItem";
			this.addToolStripMenuItem.Size = new Size(222, 24);
			...
			this._cmsActivity.Size = new Size(349, 160);
			// 
		...
		private ToolStripLabel _lblComponent;
